...
public class StateTabAdapter extends RecyclerView.Adapter<StateTabAdapter.MyViewHolder> {
...
//                mainLayout = (RelativeLayout) vi.findViewById(R.id.mainLayout);
    ...
    public StateTabAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
...
//
//}
        view.setOnClickListener(StateTabFragment.myOnClickListener);
